          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-8">
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-[#2529ff]">By Youth, For Youth</h3>
                <h4 className="text-lg font-semibold text-[#21272a]">We are a "Youth Leadership" movement</h4>
              ...
              <p className="font-medium text-[#61646b]">Website: {" "} 
                <Link
